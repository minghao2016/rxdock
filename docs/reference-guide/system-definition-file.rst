...
* Receptor input files and flexibility parameters (the section called :ref:`Receptor definition <sdf-receptor>`)
* Explicit solvent input file and flexibility parameters (the section called :ref:`Solvent definition <sdf-solvent>`)
* Ligand flexibility parameters (the section called :ref:`Ligand definition <sdf-ligand>`).
* External restraint terms to be added to the total scoring function (e.g. :ref:`cavity restraint <sdf-cavity-restraint>`, :ref:`pharmacophoric restraint <sdf-pharmacophore-restraints>`)
